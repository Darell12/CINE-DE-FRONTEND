        ...
        <div className='flex w-full'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    ...
                    <h1 className='font-bold text-6xl uppercase text-center md:w-2/3 mx-auto'>Ingresa y disfruta de las mejores <span className='text-sky-700'>Peliculas</span></h1>
                    <form 
