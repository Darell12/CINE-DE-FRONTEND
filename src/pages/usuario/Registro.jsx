    ...
    const handleSudmit = async (e) =>{
        ...
        setAlerta({});
          ...
          try {
            ...
            const {data} = await clienteAxios.post('/usuarios', { nombre, identificacion, email, password, telefono } );
            ...
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    ...
                    >
                        ...
                        <div className='mb-5'>
                            <label htmlFor="direccion" className='font-medium'>Identificacion</label>
                            <input 
                                type="text" 
                                id="direccion" 
                                className='block placeholder-slate-400 p-2 w-full bg-slate-100' 
